...
namespace CrtAiTwinApp {
	...
	/// This is the MAIN entry point into the CrtAiTwinApp package.
	/// </summary>
	public sealed class CrtAiTwinApp {

		#region Fields: Private

		private static Lazy<CrtAiTwinApp> _instance = new Lazy<CrtAiTwinApp>(() => new CrtAiTwinApp());
		...
		public static CrtAiTwinApp Instance => _instance.Value;
		...
		/// </summary>
		/// <returns></returns>
		internal CrtAiTwinApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<CrtAiTwinApp>(() => new CrtAiTwinApp());
